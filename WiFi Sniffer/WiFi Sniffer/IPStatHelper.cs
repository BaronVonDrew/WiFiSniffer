...
namespace WiFi_Sniffer
{
    class IPStatHelper
    {
        ...
        public Process GetProcessByPort(int port)
        {
            //Finds the process according to the port being used. 
            Process p = null;

            foreach (TcpRow tcpr in ManagedIpHelper.GetExtendedTcpTable(true))
            {
